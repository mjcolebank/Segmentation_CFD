...
extern "C" void impedance_driver_(int *tmstps, double *Period,
                                  ...
                                  double *y, double *Res1, double *Res2,
                                  double *CT, double *LT);
...
//    fprintf(stdout, "R1=%8.4f, R2=%8.4f, CT=%8.4f, LT=%8.4f\n",Res1, Res2, CT, LT);
...
//    fprintf(stdout, "R1=%8.4f, R2=%8.4f, CT=%8.4f, LT=%8.4f\n",Res1, Res2, CT, LT);
    impedance_driver_(&tmstps,&Period,&rbot,&rmin,y,&Res1,&Res2,&CT,&LT);
...
double Tube :: P (int i, double A)
{
  ...
  double pold = fr[i]*(1.0-sqrt(A0[i]/A));
